      ...
      <div className="flex">
        ...
        <AnimatePresence>
          {showNavbar && (
            <motion.aside
              ...
              className="w-64 bg-gray-800 bg-opacity-50 backdrop-blur-md min-h-screen p-4 flex flex-col justify-between"
            >
              <div>
              ...
              <button className="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-700 rounded-md transition-colors">
        ...
        <main className="flex-1 p-6">
          ...
          <motion.div
            ...
            className="bg-gray-800 bg-opacity-50 backdrop-blur-md rounded-lg shadow-xl p-6"
          >
